...
workflow encode_mapping_workflow {
    ...
    output {
        File dup_file_qc = filter_qc.dup_file_qc
        File filtered_map_stats = filter_qc.filtered_map_stats
        File pbc_file_qc = filter_qc.pbc_file_qc
        File unfiltered_flagstats = post_processing.unfiltered_flagstats
        File cc_file = xcor.cc_file
    }
}
